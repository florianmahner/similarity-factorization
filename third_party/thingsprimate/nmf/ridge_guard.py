#!/usr/bin/env python3
"""
Compute ridge-guard R² scores for SymNMF components across families.

Outputs per-family CSVs under nmf/results/guard_<family>.csv
...
def main():
    parser = argparse.ArgumentParser(description="Compute ridge guard scores for SymNMF components.")
    ...
    for family in args.families:
        if family not in results:
            print(f"[ridge_guard] Family '{family}' missing in ADMM results, skipping.")
            continue
