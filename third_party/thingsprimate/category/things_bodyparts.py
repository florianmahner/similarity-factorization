...
for the behavioral "body part" dimension from the THINGS dataset, using
the same mosaic/density layout as nmf/viz_grid.py (no subsampling).
"""
...
# Layout (mirrors nmf/viz_grid deterministic grid)
ROWS = 10
COLS = 10
IMG_PX = 200
