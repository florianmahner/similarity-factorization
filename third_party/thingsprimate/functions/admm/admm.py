...
from sklearn.utils.validation import check_is_fitted, check_symmetric, check_array
...
class ADMM(TransformerMixin, BaseEstimator):
    ...
    @classmethod
    def check_cython_status(cls):
        """Check and report Cython implementation status."""
        try:
            from .bsum import update_w
            print("ADMM: Cython")
            return True
