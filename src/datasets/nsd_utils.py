"""Utility functions for loading Natural Scenes Dataset (NSD)."""
...
def load_nsd_data(
    ...
    """
    High-level function to load NSD data.
    ...
    zscore_betas : bool, default=True
        Whether to z-score betas
    return_images : bool, default=True
        Whether to return images
    nsd_dir : Path, default=NSD_DIR_IRIS
        NSD directory path
    ...
    """
    subjects = get_available_subjects(nsd_dir)
