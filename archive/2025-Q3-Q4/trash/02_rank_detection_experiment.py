""" 
This script tests how well we can detect the true matrix rank using ADMM edge masking. 
What we do is to actually manipulate the fraction og objserved similarities to see how this influences the rank detection. 
"""
...
def run_experiment(
    ...
    results_output_file = output_dir / "cross_validation/rank_detection.csv"
