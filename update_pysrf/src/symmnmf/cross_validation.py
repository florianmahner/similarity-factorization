...
def mask_missing_entries(
    ...
    # Diagonal is always observed. This matches the spectral pass convention
    # `keep_diag=True` in _compute_coherence._prepare_observation_mask; prior to
    # 2026-05-11 the line below was commented out, which silently marked the
    # diagonal as missing in CV while the spectral pass preserved it. See
    # RECIPE_K_THESIS_REBUTTAL_ROUND1.md (issue #13).
