...
from srf.models.symmetric import SymmetricCD
...
#     """Permutation test for the correlation between two similarity matrices"""
...
#     observed_corr = pearsonr(sim1, sim2).statistic
...
#         B_perm = B[perm][:, perm]
#         sim2_perm = B_perm[idx_upper]

#         # Permuted correlation of null distribution
#         perm_corr = pearsonr(sim1, sim2_perm).statistic
...
def process_single_run(
    ...
    denoised_similarity /= denoised_similarity.max()
            ...
            results.append(
                {
                    ...
                    "Rec_error": model.history["rec_error"][-1],
...
if __name__ == "__main__":
    ...
    # test = process_single_run(model, data, hypotheses, 0.5, 0, cfg.n_permutations)
    # breakpoint()
